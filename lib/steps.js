...
// the build pipeline in order; bin/build.js runs these (optionally a named subset). The
// one-time source-mirror fetch (`download`, above) is run separately via bin/download.js.
export const steps = [
