...
// 2. Render the mirror into one global Web Mercator raster for the given zoom level.
//
// The source tiles are mosaicked with a VRT and reprojected to EPSG:3857 at
// sizeForLevel(level)² pixels covering the standard Mercator square (±MERC m), resampled
// "mode" (dominant class — the only correct choice for categorical data).
// data/worldcover-3857.tif is a single Byte band with class codes {0,10,…,100}.
